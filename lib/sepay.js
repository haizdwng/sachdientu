...
export const createPayment = (orderData) => {
  const fields = client.checkout.initOneTimePaymentFields({
    ...
    success_url: `${process.env.NEXT_PUBLIC_SITE_URL}/payment/success?order=${orderData.code}`,
    cancel_url: `${process.env.NEXT_PUBLIC_SITE_URL}/payment/cancel?order=${orderData.code}`,
  });
